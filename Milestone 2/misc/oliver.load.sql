...
INSERT INTO transport VALUES    (default, 'Frankfurt', 'Tokyo Haneda', 'plane'),
                                (default, 'Osaka', 'Frankfurt', 'plane'),
                                (default, 'Basel', 'Luzern', 'bus'),
                                (default, 'Lausanne', 'Zürich', 'train'),
                                (default, 'Zürich', 'Vancouver', 'plane'),
                                (default, 'Vancouver', 'Vancouver', 'other');
...
--has_transport(trip_id, transport_id, date)
INSERT INTO has_transport VALUES    (9, 5, '2021-09-04'),
                                    (9, 6, '2021-09-25'),
                                    (8, 7, '2021-09-09'),
                                    (6, 8, '2021-09-04'),
                                    (6, 9, '2021-09-04'),
